...
All six activity photographs are stored locally in the `assets` folder. See `assets/README.md` for the filename assigned to each activity screen and the simplest replacement process.
